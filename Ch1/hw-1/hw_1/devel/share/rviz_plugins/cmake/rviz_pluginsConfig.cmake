...
if("TRUE" STREQUAL "TRUE")
  set(rviz_plugins_SOURCE_PREFIX /home/wrk/File/Other_file/SLAM/My_course/Motion_Planning/Ch1/hw-1/hw_1/src/rviz_plugins)
  set(rviz_plugins_DEVEL_PREFIX /home/wrk/File/Other_file/SLAM/My_course/Motion_Planning/Ch1/hw-1/hw_1/devel)
  ...
  set(rviz_plugins_INSTALL_PREFIX /home/wrk/File/Other_file/SLAM/My_course/Motion_Planning/Ch1/hw-1/hw_1/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'rviz_plugins' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/wrk/File/Other_file/SLAM/My_course/Motion_Planning/Ch1/hw-1/hw_1/src/rviz_plugins/${idir}'.  ${_report}")
    endif()
